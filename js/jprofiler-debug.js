...
jProfiler = function(){
    ...
    /**
     * work around to remove YUI related codes
     */
    ...
    return {
         ...
         * @param  {string} funcName the whole name of function which is profiled
         * @return {[type]}          [description]
         */
        showReport: function(funcName) {
            var report = this.getFullReport(function(data){
                return data.calls > 0;
            });

            if(funcName && report[funcName]){
                console.log(funcName + "(): Called " + report[funcName].calls + " times. Avg: " + 
                    report[funcName].avg + ", Min: " + report[funcName].min + ", Max: " + report[funcName].max);
            } else if(funcName){
                console.log(func + "doesn't be profiled");
            } else {
                for (var func in report){
                    console.log(func + "(): Called " + report[func].calls + " times. Avg: " + 
